...
class RestrictionDigestManagerTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->apiMock->method("getTypeIIEndonucleases")->will($this->returnValue($aType2));
        $this->apiMock->method("getTypeIIsEndonucleases")->will($this->returnValue($type2s));
        $this->apiMock->method("getTypeIIbEndonucleases")->will($this->returnValue($type2b));
