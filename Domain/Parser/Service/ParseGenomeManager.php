...
use Amelaye\BioPHP\Domain\Parser\Entity\GenomeReference;
 ...
 * of references rather than a sequence, so this class exposes plain scalars and
 * GenomeReferenceInterface objects rather than the Sequence/Feature entities of
 * ParseDbAbstractManager. Its continuation
...
final class ParseGenomeManager implements ParseDatabaseInterface
{
     ...
     * @param   GenomeReferenceInterface|null    $oReference     The reference set, if one is open
    ...
    /**
     * @return GenomeReferenceInterface[]
     */
